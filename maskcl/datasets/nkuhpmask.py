...
class NKUHPMASKdataset(BaseImageDataset):
    ...
    def __init__(self, root, verbose=True, **kwargs):
        super(NKUHPMASKdataset, self).__init__()
    ...
    def _process_dir_train(self, dir_path, relabel=False):
        ...
        for image in img_paths:
            ...
            clothes = int(image.split('_')[1][1:])
            cid = int(image.split('_')[2][1:3])
